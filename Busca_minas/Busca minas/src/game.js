...
function applyCustomGame () {
  try {
    ...
    if (hasNonDigits.test(customGridWidth)) {
      document.getElementById("modal-msg").innerHTML = "Introduce un ancho valido.";
      return;
    }
    if (hasNonDigits.test(customGridHeight)) {
      document.getElementById("modal-msg").innerHTML = "Introduce una altura valida.";
      return;
    }
    if (hasNonDigits.test(customMaxMines)) {
      document.getElementById("modal-msg").innerHTML = "Ingresa un numero valido de minas.";
      return;
    }

    if (customGridWidth < 6) {
      document.getElementById("modal-msg").innerHTML = "Ingresa un ancho más grande.";
      return;
    }
    if (customGridHeight < 6) {
      document.getElementById("modal-msg").innerHTML = "Ingresa una altura más grande.";
      return;
    }
    if (customGridWidth > 64) {
      document.getElementById("modal-msg").innerHTML = "Introduce una anchura menor.";
      return;
    }
    if (customGridHeight > 64) {
      document.getElementById("modal-msg").innerHTML = "Introudece una altura menor.";
      return;
    }

    if (customMaxMines > customGridWidth * customGridHeight - 9) {
      document.getElementById("modal-msg").innerHTML = "Demasiadas minas.";
      return;
    }
    if (customMaxMines < 1) {
      document.getElementById("modal-msg").innerHTML = "Muy pocas minas.";
      return;
    }
    ...
    document.getElementById("modal-msg").innerHTML = "Un error ha ocurrido";
    console.log(err);
  }
}
